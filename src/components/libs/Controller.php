...
class Controller extends Component implements ViewContextInterface
{
    ...
    {
        // add by qinxianwu,传递只返回html字符串的参数
        if (isset($params['onlyContentHtml']) && $params['onlyContentHtml']) {
            Yii::$app->params['onlyContentHtml'] = TRUE;
        } else {
            Yii::$app->params['onlyContentHtml'] = FALSE;
        }
    ...
    public function beforeAction($action)
    {
        // 给load方法设置是否直接返回TURE的表示
        if (isset(Yii::$app->params['onlyContentHtml'])) {
            # code...
        } else {
            Yii::$app->params['onlyContentHtml'] = FALSE;
        }
